...
<title>ABCRestaurent | Staff Login</title>
</head>
<body>
        ...
        <div
            ...
            <div class="flex h-full flex-col justify-center gap-4 p-6">
                <div class="left-0 right-0 inline-block border-gray-200 px-2 py-2.5 sm:px-4">
                    <form action="<%= request.getContextPath()%>/admin-signup" method="post" class="flex flex-col gap-4 pb-4">
                    ...
                    <div class="min-w-[270px]">
                        <div class="mt-4 text-center dark:text-gray-200">Already an user?
                            <a class="text-blue-500 underline hover:text-blue-600" href="/signup">login
                                here</a>
                        </div>
                    </div>
                </div>
