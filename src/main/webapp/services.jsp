...
<head>
    ...
    <style>
        .highlight {
            ...
            border-radius: 0.375rem; /* Rounded corners for the highlight */
        }
    </style>
</head>
<body>
...
<nav class="bg-white fixed top-0 z-20 border-gray-200 py-2.5 w-screen dark:bg-gray-900">
    ...
    <section class="container mx-auto p-10 md:p-20 antialiased">
        ...
        <!-- Search box -->
        <div class="mb-6">
            <input type="text" id="searchBox" onkeyup="filterServices()" placeholder="Search for services..." 
                   class="p-2 ml-[300px] flex flex-row items-center justify-center border border-gray-300 rounded-lg max-w-3xl w-full">
        </div>
        ...
        <div id="servicesContainer">
            ...
            <article class="service-item flex flex-wrap md:flex-nowrap shadow-lg mx-auto rounded-lg max-w-3xl group cursor-pointer transform duration-500 hover:-translate-y-1">
                <img class="w-full max-h-[400px] rounded-lg object-cover md:w-52" src="<%= services.getImage() %>" alt="">
                <div>
                    <div class="p-5 pb-10">
                        ...
                        <div class="sm:flex sm:justify-between">
                            <div>
                                <div class="text-lg text-gray-700">
                                    <span class="text-gray-900 font-bold">LKR</span> <%= services.getPrice() %>
                                </div>
                                <div class="text-lg text-center w-[100px] text-green-300 border-green-300 border-2 rounded-lg">
                                    <%= services.getAvailability() %>
                                </div>
                                <div class="flex items-center">
                                    <div class="flex">
                                        <!-- Rating icons -->
                                        <!-- You can add dynamic rating logic here if needed -->
                                        <svg class="w-4 h-4 mx-px fill-current text-green-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14">
  ...
  <div class="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
    ...
    <script>
        function filterServices() {
            var input, filter, container, items, h1, i, txtValue;
            input = document.getElementById('searchBox');
            filter = input.value.toLowerCase();
            container = document.getElementById("servicesContainer");
            items = container.getElementsByClassName('service-item');
            ...
            for (i = 0; i < items.length; i++) {
                h1 = items[i].getElementsByTagName("h1")[0];
                if (h1) {
