...
<div class="flex items-center mt-[100px] justify-center p-12">
    <!-- Author: FormBold Team -->
    <div class="mx-auto w-full max-w-[550px] bg-white">
        <form action="<%= request.getContextPath()%>/AddReserveServelet" method="post">
            ...
            <div class="mb-5">
                ...
                <input type="number" name="phone" id="phone" placeholder="0712345678" min="0"
                    class="w-full appearance-none rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
            </div>
             ...
             <div class="mb-5">
                ...
                <input type="text" name="type" id="type" placeholder="Birthday" min="0"
                    class="w-full appearance-none rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
            </div>
